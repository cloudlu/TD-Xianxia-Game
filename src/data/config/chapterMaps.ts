...
// ===== BOTTOM-BASE ch20-24 =====,
  ch20: {
    ...
    blocked: [
      ...
      { col: 0, row: 4, terrain: 'rock' },
      { col: 20, row: 2, terrain: 'rock' },
      { col: 11, row: 0, terrain: 'rock' },
      { col: 10, row: 10, terrain: 'tree' },
      { col: 13, row: 9, terrain: 'tree' },
  ...
  ch22: {
    ...
    blocked: [
      ...
      { col: 10, row: 0, terrain: 'water' },
      { col: 14, row: 10, terrain: 'water' }
    ],
    paths: [
