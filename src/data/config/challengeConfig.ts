 ...
 *   mono_school — 单流派（params: { allowed: 流派名 }，多个流派用逗号分隔）
 *   no_upgrade  — 禁止升级塔
 *   no_aura     — 禁止放置光环塔（聚灵阵）
...
const CHALLENGES: Record<string, ChallengeDef[]> = {
  ...
  // ════════════════════════════════════════════
  'ch2-l1': [
    { id: 'ch2-l1_magic', name: '雷法破蝠', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 35 },
  ...
  'ch4-l3': [
    { id: 'ch4-l3_speed', name: '凶兽伏诛', desc: '70 秒内通关', kind: 'speed', params: { limit: 70 }, rewardContrib: 50 },
    { id: 'ch4-l3_magic', name: '法术破隐', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 45 },
  ],
  ...
  // ════════════════════════════════════════════
  'ch6-l1': [
    { id: 'ch6-l1_speed', name: '域外疾行', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 45 },
    { id: 'ch6-l1_magic', name: '法术破甲', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 40 },
  ],
  'ch6-l2': [
  ...
  'ch6-l3': [
    { id: 'ch6-l3_speed', name: '裂隙封印', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 55 },
    { id: 'ch6-l3_talisman', name: '符裂虚空', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 50 },
  ],
  ...
  // ════════════════════════════════════════════
  'ch7-l1': [
    { id: 'ch7-l1_speed', name: '烽火连天', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 50 },
    { id: 'ch7-l1_magic', name: '烈火燎原', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 45 },
  ],
  'ch7-l2': [
    { id: 'ch7-l2_budget', name: '稳扎稳打', desc: '总消费不超过 1000 灵石', kind: 'budget', params: { limit: 1000 }, rewardContrib: 50 },
    { id: 'ch7-l2_bow', name: '符镇八方', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 45 },
  ],
  'ch7-l3': [
  ...
  // ════════════════════════════════════════════
  'ch8-l1': [
    { id: 'ch8-l1_speed', name: '电光石火', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 50 },
    { id: 'ch8-l1_magic', name: '雷法通天', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 45 },
  ],
  'ch8-l2': [
  ...
  'ch8-l3': [
    { id: 'ch8-l3_speed', name: '斩妖除魔', desc: '70 秒内通关', kind: 'speed', params: { limit: 70 }, rewardContrib: 55 },
    { id: 'ch8-l3_magic', name: '雷火降妖', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 50 },
  ],
  ...
  // ════════════════════════════════════════════
  'ch9-l1': [
    { id: 'ch9-l1_speed', name: '风卷残云', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 50 },
  ...
  'ch9-l2': [
    ...
    { id: 'ch9-l2_bow', name: '万符归宗', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 50 },
  ],
  'ch9-l3': [
  ...
  // ════════════════════════════════════════════
  'ch10-l1': [
    { id: 'ch10-l1_speed', name: '主宰苏醒', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 55 },
    { id: 'ch10-l1_budget', name: '阵法困兽', desc: '总消费不超过 1000 灵石', kind: 'budget', params: { limit: 1000 }, rewardContrib: 50 },
  ],
  'ch10-l2': [
    { id: 'ch10-l2_budget', name: '裂隙精算', desc: '总消费不超过 1200 灵石', kind: 'budget', params: { limit: 1200 }, rewardContrib: 55 },
    { id: 'ch10-l2_magic', name: '法破虚空', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 50 },
  ],
  'ch10-l3': [
    { id: 'ch10-l3_speed', name: '封印主宰', desc: '70 秒内通关', kind: 'speed', params: { limit: 70 }, rewardContrib: 65 },
    { id: 'ch10-l3_magic', name: '万法归墟', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 60 },
  ],
  ...
  // ════════════════════════════════════════════
  'ch11-l1': [
    { id: 'ch11-l1_speed', name: '联盟疾驰', desc: '60 秒内通关', kind: 'speed', params: { limit: 60 }, rewardContrib: 55 },
  ...
  'ch11-l2': [
    ...
    { id: 'ch11-l2_talisman', name: '符破影杀', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 50 },
  ],
  'ch11-l3': [
    { id: 'ch11-l3_speed', name: '骑兵克星', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 60 },
    { id: 'ch11-l3_magic', name: '法术破骑', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 55 },
  ],
  ...
  'ch12-l3': [
    { id: 'ch12-l3_speed', name: '暗影追风', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 60 },
    { id: 'ch12-l3_bow', name: '符影追踪', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 55 },
  ],
  ...
  'ch13-l3': [
    { id: 'ch13-l3_speed', name: '困蛟于滩', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 65 },
  ...
  'ch14-l2': [
    { id: 'ch14-l2_bow', name: '符甲克星', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 55 },
  ...
  'ch15-l3': [
    { id: 'ch15-l3_speed', name: '万军取首', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 70 },
    { id: 'ch15-l3_magic', name: '法术斩帅', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 65 },
  ],
  ...
  // ════════════════════════════════════════════
  'ch16-l1': [
    { id: 'ch16-l1_speed', name: '百族疾风', desc: '60 秒内通关', kind: 'speed', params: { limit: 60 }, rewardContrib: 60 },
    { id: 'ch16-l1_magic', name: '龙族克星', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 55 },
  ],
  'ch16-l2': [
    { id: 'ch16-l2_bow', name: '符射天敌', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 55 },
    { id: 'ch16-l2_budget', name: '百族理财', desc: '总消费不超过 1550 灵石', kind: 'budget', params: { limit: 1550 }, rewardContrib: 60 },
  ],
  'ch16-l3': [
    { id: 'ch16-l3_speed', name: '龙裔伏诛', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 65 },
  ...
  // ════════════════════════════════════════════
  'ch17-l1': [
    { id: 'ch17-l1_speed', name: '鬼影追风', desc: '60 秒内通关', kind: 'speed', params: { limit: 60 }, rewardContrib: 60 },
    { id: 'ch17-l1_magic', name: '阳雷破鬼', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 55 },
  ],
  'ch17-l2': [
    { id: 'ch17-l2_talisman', name: '符镇群鬼', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 55 },
  ...
  'ch18-l3': [
    { id: 'ch18-l3_speed', name: '百族之王', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 65 },
    { id: 'ch18-l3_bow', name: '箭雨遮天', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 60 },
  ],
  ...
  'ch19-l2': [
    ...
    { id: 'ch19-l2_magic', name: '雷火交加', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 60 },
  ],
  'ch19-l3': [
    { id: 'ch19-l3_speed', name: '万族朝宗', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 70 },
  ...
  'ch20-l2': [
    ...
    { id: 'ch20-l2_talisman', name: '符御天妖', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 60 },
  ],
  'ch20-l3': [
    { id: 'ch20-l3_speed', name: '蛊王伏法', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 75 },
    { id: 'ch20-l3_magic', name: '五雷诛王', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 70 },
  ],
  ...
  // ════════════════════════════════════════════
  'ch21-l1': [
    { id: 'ch21-l1_speed', name: '界域之门', desc: '60 秒内通关', kind: 'speed', params: { limit: 60 }, rewardContrib: 65 },
    { id: 'ch21-l1_magic', name: '虚空雷法', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 60 },
  ],
  'ch21-l2': [
    { id: 'ch21-l2_bow', name: '符锁虚空', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 60 },
  ...
  // ════════════════════════════════════════════
  'ch22-l1': [
    { id: 'ch22-l1_speed', name: '二十二快', desc: '60 秒内通关', kind: 'speed', params: { limit: 60 }, rewardContrib: 65 },
  ...
  'ch22-l3': [
    { id: 'ch22-l3_speed', name: '界域守护', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 70 },
    { id: 'ch22-l3_magic', name: '天雷破界', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 65 },
  ],
  ...
  // ════════════════════════════════════════════
  'ch23-l1': [
    { id: 'ch23-l1_speed', name: '天外飞仙', desc: '60 秒内通关', kind: 'speed', params: { limit: 60 }, rewardContrib: 65 },
    { id: 'ch23-l1_budget', name: '阵困虚空', desc: '总消费不超过 1600 灵石', kind: 'budget', params: { limit: 1600 }, rewardContrib: 60 },
  ],
  'ch23-l2': [
  ...
  'ch23-l3': [
    { id: 'ch23-l3_speed', name: '混沌退散', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 70 },
    { id: 'ch23-l3_bow', name: '符箭破虚', desc: '仅使用符修塔通关', kind: 'mono_school', params: { allowed: 'talisman' }, rewardContrib: 65 },
  ],
  ...
  'ch24-l3': [
    { id: 'ch24-l3_speed', name: '界域终战', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 70 },
    { id: 'ch24-l3_magic', name: '万雷齐鸣', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 65 },
  ],
  ...
  'ch25-l3': [
    { id: 'ch25-l3_speed', name: '化身破灭', desc: '65 秒内通关', kind: 'speed', params: { limit: 65 }, rewardContrib: 80 },
  ...
  // ════════════════════════════════════════════
  'ch26-l1': [
    { id: 'ch26-l1_speed', name: '飞升疾行', desc: '60 秒内通关', kind: 'speed', params: { limit: 60 }, rewardContrib: 70 },
    { id: 'ch26-l1_spear', name: '屠兽之枪', desc: '仅使用枪修塔通关', kind: 'mono_school', params: { allowed: 'spear' }, rewardContrib: 65 },
  ],
  'ch26-l2': [
    { id: 'ch26-l2_magic', name: '天雷灭兽', desc: '仅使用法修塔通关', kind: 'mono_school', params: { allowed: 'fire,thunder,ice' }, rewardContrib: 65 },
