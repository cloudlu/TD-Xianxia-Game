...
export const CH5_L1: LevelConfig = {
  ...
  waves: [
    { spawns: [
      ...
      { enemy: 'bat', count: 10, gap: 0.4, delay: 1, path: 1 },
      { enemy: 'magic_minion', count: 5, gap: 1.2, delay: 0, path: 2 },
    ], clearBonus: 160 },
    { spawns: [
      { enemy: 'shadow_fox', count: 5, gap: 1.2, delay: 0, path: 0 },
      { enemy: 'bull', count: 1, gap: 1, delay: 1, path: 1 },
