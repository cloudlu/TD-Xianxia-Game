...
export const CH1_L3: LevelConfig = {
  ...
  waves: [
    ...
    { spawns: [{ enemy: 'wolf', count: 10, gap: 0.6, delay: 1 }, { enemy: 'boar', count: 3, gap: 2, delay: 2 }], clearBonus: 90 },
    // 末波：山猪王率众来犯
    { spawns: [{ enemy: 'boar', count: 4, gap: 1.6, delay: 1 }, { enemy: 'boar_king', count: 1, gap: 1, delay: 4 }], clearBonus: 150 },
  ],
  story: {
    intro: {
