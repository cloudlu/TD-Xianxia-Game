...
export const CH5_L2: LevelConfig = {
  ...
  waves: [
    { spawns: [
      ...
      { enemy: 'magic_puppet', count: 3, gap: 2.5, delay: 0, path: 1 },
      { enemy: 'shadow_fox', count: 6, gap: 1, delay: 1, path: 2 },
    ], clearBonus: 190 },
    { spawns: [
      { enemy: 'magic_minion', count: 8, gap: 0.9, delay: 0, path: 0 },
      { enemy: 'splitter', count: 8, gap: 1, delay: 0, path: 1 },
      { enemy: 'bat', count: 14, gap: 0.35, delay: 1, path: 2 },
    ], clearBonus: 220 },
    { spawns: [
