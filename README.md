...
共 **280+ 个单元测试**，覆盖：战斗结算（护甲/护盾/回血/暴击/闪避/遁地）、路径几何、波次队列、目标选择、攻击策略（projectile/pierce/aoe/chain/mine）、Modifier 封顶与跨 stat 合并、BOSS 狂暴/魅惑/召唤、击退、经济、星级、解锁逻辑、挑战验证（5 种 kind）、无尽模式、装备/天赋/皮肤/塔配置、图鉴。
